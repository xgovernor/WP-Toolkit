<?php
    ...
    <div class="privacy-settings-header wp">
        ...
        <nav class="privacy-settings-tabs-wrapper hide-if-no-js" style="grid-template-columns: repeat(4, 1fr);" aria-label="WPL Toolkit Settings Tabs">
            ...
            <a href="?page=wpl-toolkit-settings&tab=activation" class="privacy-settings-tab <?php echo $active_tab === 'activation' ? 'active' : ''; ?>">
                <?php esc_html_e('Activation', 'wpl-toolkit'); ?>
            </a>
            <a href="?page=wpl-toolkit-settings&tab=settings" class="privacy-settings-tab <?php echo $active_tab === 'settings' ? 'active' : ''; ?>">
                <?php esc_html_e('Settings', 'wpl-toolkit'); ?>
            </a>
            <a href="?page=wpl-toolkit-settings&tab=help" class="privacy-settings-tab <?php echo $active_tab === 'help' ? 'active' : ''; ?>">
